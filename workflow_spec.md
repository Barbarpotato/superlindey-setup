# LindseyEngine Code Generator - Workflow Specification

## Overview

The LindseyEngine code generator is a PHP-based system that automatically generates database interaction layers, hooks, and wrapper classes from a JSON configuration file. It creates a complete CRUD and state management system for web applications.
...
- Collect all operations from models
- Generate `Library/engine/_LindseyEngine.php` with:
    - Database connection handling
    - CRUD methods (get, set, delete)
...
- Treated as separate entities with own hooks and wrappers

### Child Objects

- Sub-models under `model["child_objects"][]`
- Same processing as grouping objects
